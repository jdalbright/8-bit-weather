...
Current conditions are estimates. Explicit zero ordinary-rain rates resolve to cloud conditions. Missing rates never mean dry. Chance/nearby qualifiers do not animate local precipitation without positive local evidence; nearby precipitation remains qualified even with a positive rate. The server supplies the same resolved code and label to the app and widget. Legacy snapshots remain readable and trigger a fresh provider request on first online use.
