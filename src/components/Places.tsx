...
export default function Places({ places, selected, locating, onLocate, onSelect, onRemove }: Props) {
  ...
  return <main id="main-content" className="utility-view places-view">
