...
export default function Settings({ preferences, onChange, audio, install, systemReduced, onClear }: Props) {
  ...
  return <main id="main-content" tabIndex={-1} className="utility-view settings-view">
    ...
    <section className="settings-section" aria-labelledby="data-title"><h2 id="data-title">Your device, your data</h2><p className="settings-description">Places, preferences, forecasts, and saved briefings stay in this browser. Coordinates are sent to Open-Meteo to get your forecast. Forecast data is sent to OpenAI to write your briefing, without your coordinates or saved place names. No account or analytics.</p>
