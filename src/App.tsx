...
import { setHapticsEnabled, triggerHaptic } from './lib/native-experience';
...
export default function App() {
  ...
  async function manualRefresh() {
    ...
    audio.effect();
    try { await weather.refresh(true, () => triggerHaptic('impact')); } finally { manualPending.current = false; }
  }
  function clearData() {
    focusMain.current = true;
